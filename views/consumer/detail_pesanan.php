<div style="display: flex; flex-wrap: wrap; gap: 20px; margin-top: 10px; font-family: 'Segoe UI', sans-serif;">
...
<div style="background: #ffffff; padding: 25px; border-radius: 12px; border: 1px solid #8EB69B; margin-top: 30px; box-shadow: 0 4px 10px rgba(5, 31, 32, 0.05); font-family: 'Segoe UI', sans-serif;">
    ...
    <?php if ($status_lower == 'menunggu pembayaran'): ?>
        ...
        <?php if(($detail_pesanan['metode_pembayaran'] ?? '') === 'Transfer Bank'): ?>
            ...
            <div style="background: #F7FAF8; border: 1px solid #DAF1DE; padding: 25px; border-radius: 12px;">
                ...
                <form action="index.php?area=consumer&action=upload_bukti" method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" style="width: 100%; background: #f2d472; color: #051F20; padding: 15px; border: none; border-radius: 6px; font-weight: 900; cursor: pointer; text-transform: uppercase; letter-spacing: 1px;">
    ...
    <?php elseif ($status_lower == 'menunggu verifikasi'): ?>
        <div style="background: #fef9c3; border: 1px solid #fde047; color: #854d0e; padding: 25px; border-radius: 8px; text-align: center; font-size: 1.1rem;">
            ...
            Bukti pembayaran Anda sudah kami terima dan sedang dicek oleh Admin. Harap tunggu ya!
        </div>
    ...
    <?php elseif ($status_lower == 'dikirim'): ?>
    ...
    <?php elseif ($status_lower == 'selesai'): ?>
        <div style="background: #f0fdf4; border: 1px solid #bbf7d0; color: #166534; padding: 25px; border-radius: 8px; text-align: center; font-size: 1.1rem;">
            ...
            <?php endif; ?>
            <br><span style="font-size: 0.95rem; opacity: 0.8;">Terima kasih telah mempercayakan belanja frozen food Anda di Lezaat!</span>
        </div>
