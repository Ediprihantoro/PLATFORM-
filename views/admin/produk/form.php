<div style="font-family: 'Segoe UI', sans-serif; max-width: 700px; margin: 0 auto; padding-top: 10px;">
    ...
    <div style="background: #ffffff; padding: 40px; border-radius: 12px; border: 1px solid #8EB69B; box-shadow: 0 10px 25px rgba(5, 31, 32, 0.05); margin-top: 20px;">
        ...
        <form action="index.php?area=admin&action=simpan_produk" method="POST">
            
            <div style="margin-bottom: 20px;">
                <label style="display: block; margin-bottom: 8px; color: #163832; font-weight: bold;">Nama Produk</label>
                <input type="text" name="namaProduk" required style="width: 100%; padding: 12px; border-radius: 6px; border: 1px solid #8EB69B; background: #F7FAF8; color: #051F20; box-sizing: border-box; font-size: 1rem;">
            </div>
            
            <div style="margin-bottom: 20px;">
                <label style="display: block; margin-bottom: 8px; color: #163832; font-weight: bold;">Kategori</label>
                <input type="text" name="kategori" required style="width: 100%; padding: 12px; border-radius: 6px; border: 1px solid #8EB69B; background: #F7FAF8; color: #051F20; box-sizing: border-box; font-size: 1rem;">
            </div>
            
            <div style="margin-bottom: 20px;">
                <label style="display: block; margin-bottom: 8px; color: #163832; font-weight: bold;">Harga Eceran (Rp)</label>
                <input type="number" name="harga_eceran" required style="width: 100%; padding: 12px; border-radius: 6px; border: 1px solid #8EB69B; background: #F7FAF8; color: #051F20; box-sizing: border-box; font-size: 1rem;">
            </div>
            
            <div style="margin-bottom: 25px;">
                <label style="display: block; margin-bottom: 8px; color: #163832; font-weight: bold;">Deskripsi</label>
                <textarea name="deskripsiProduk" rows="4" style="width: 100%; padding: 12px; border-radius: 6px; border: 1px solid #8EB69B; background: #F7FAF8; color: #051F20; box-sizing: border-box; font-size: 1rem; resize: vertical;"></textarea>
            </div>
